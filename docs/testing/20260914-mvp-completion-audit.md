...
| Integrated release candidate | `/Users/Shared/Iris-RC-20260914-v20/Iris Test.app`, signed with `Iris Local Code Signing` and deep-strict verified | Stable candidate exists; acceptance is incomplete until live/native/device gates close |
