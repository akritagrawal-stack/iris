...
| Integrated release candidate | `/Users/Shared/Iris-RC-20260914-v21/Iris Test.app`, signed with `Iris Local Code Signing` and deep-strict verified; executable SHA-256 `c1f86b45290c094dd6abdb1e4d69f1af55348e4d2bfa8ff9d9ea050913a34f0a` | Stable candidate exists; acceptance is incomplete until live/native/device gates close |
